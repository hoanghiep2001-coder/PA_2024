    ...
    execute: function () {
      ...
      _export("GamePlay", GamePlay = (_dec = ccclass('GamePlay'), _dec2 = property(_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
        ...
        handleVideo() {
          ...
          if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).isSecondClick) {
          ...
          if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).isFirstClick && !(_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).isSecondClick) {
            (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).isSecondClick = true;
            this.scheduleOnce(() => {
              this.video.pause();
              (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
