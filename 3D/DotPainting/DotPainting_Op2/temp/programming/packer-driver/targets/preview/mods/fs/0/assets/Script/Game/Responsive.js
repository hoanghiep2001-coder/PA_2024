System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, screen, GamePlay, Constants, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, Responsive;
    ...
    execute: function () {
      ...
      _export("Responsive", Responsive = (_dec = ccclass('Responsive'), _dec2 = property(_crd && GamePlay === void 0 ? (_reportPossibleCrUseOfGamePlay({
        ...
        setHorizontalForTablet() {
          ...
          console.log(3);
          this.GamePlay.video.node.setScale(0.6, 0.6, 0.6); // horizontal google
        ...
        setMobile() {
          ...
          if (screen.windowSize.width / screen.windowSize.height < 0.7) {
            ...
            this.GamePlay.video.node.setScale(0.5, 0.5, 0.5);
            console.log(5);
          } else {
            // Ipad
            this.GamePlay.video.node.setScale(0.5, 0.5, 0.5);
