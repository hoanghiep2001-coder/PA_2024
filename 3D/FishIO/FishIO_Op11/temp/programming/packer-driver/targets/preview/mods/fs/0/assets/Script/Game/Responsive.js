System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, screen, GamePlay, Constants, UIController, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, Responsive;
    ...
    execute: function () {
      ...
      _export("Responsive", Responsive = (_dec = ccclass('Responsive'), _dec2 = property(_crd && GamePlay === void 0 ? (_reportPossibleCrUseOfGamePlay({
        ...
        setHorizontalForIpX() {
          ...
          this.GamePlay.CTA_btn.setScale(0.22, 0.22, 0.22); // if(cc.screen.windowSize.height / cc.screen.windowSize.width >= 0.6) {
          //     // Applovin horizontal
          //     return;
          // }    
