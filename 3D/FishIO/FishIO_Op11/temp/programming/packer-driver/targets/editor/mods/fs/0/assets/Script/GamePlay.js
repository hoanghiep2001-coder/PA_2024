System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, VideoPlayer, GameController, AudioManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, GamePlay;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GamePlay", GamePlay = (_dec = ccclass('GamePlay'), _dec2 = property(_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
        ...
        error: Error()
      }), AudioManager) : AudioManager), _dec4 = property(VideoPlayer), _dec5 = property(Node), _dec(_class = (_class2 = (_temp = class GamePlay extends Component {
        constructor(...args) {
          super(...args);
        ...
        start() {
          this.video.node.on(VideoPlayer.EventType.READY_TO_PLAY, this.initVideo, this); // this.video.node.on(VideoPlayer.EventType.CLICKED, this.clicked, this);
          // this.HideMask.on(Node.EventType.TOUCH_START, this.clicked, this);
        } // private clicked() {
        //     log("Check")
        //     this.video.play();
