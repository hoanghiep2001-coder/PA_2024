    ...
    execute: function () {
      ...
      _export("SkiingController", SkiingController = (_dec = ccclass('SkiingController'), _dec2 = property(_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
        ...
        isIntersectsFlagPoint() {
          var characterBdx = this.Character.getComponent(UITransform).getBoundingBox();
          var flagPointBdx = this.FlagPoint.getComponent(UITransform).getBoundingBox();
        ...
        characterMove(dt) {
          var characterOldPos = new Vec3();
          this.Character.getPosition(characterOldPos);
          var targetPos = new Vec3(characterOldPos.x + dt * 4000, characterOldPos.y, characterOldPos.z);
          var newPos = new Vec3();
        ...
        isIntersectsReadyJumpPoint(dt) {
          ...
          var characterBdx = this.Character.getComponent(UITransform).getBoundingBox();
          var flagPointBdx = this.readyJumpPoint.getComponent(UITransform).getBoundingBox();
        ...
        isIntersectsFlagJumpPoint(dt) {
          var characterBdx = this.Character.getComponent(UITransform).getBoundingBox();
          var flagPointBdx = this.FlagJumpPoint.getComponent(UITransform).getBoundingBox();
        ...
        characterJump(dt) {
          ...
          var characterOldPos = this.Character.getPosition();
        ...
        characterFall(dt) {
          var characterOldPos = new Vec3();
          this.Character.getPosition(characterOldPos);
          var targetPos = new Vec3(characterOldPos.x, characterOldPos.y - dt * 8000, characterOldPos.z);
          var newPos = new Vec3();
          Vec3.lerp(newPos, characterOldPos, targetPos, dt * 5); // Sử dụng lerp để tạo chuyển động mượt mà
