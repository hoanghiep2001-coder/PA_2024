System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Vec3, UIController, GameController, AudioManager, GamePlay, Constants, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, TouchArea;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TouchArea", TouchArea = (_dec = ccclass('TouchArea'), _dec2 = property(_crd && UIController === void 0 ? (_reportPossibleCrUseOfUIController({
        ...
        start() {// this.UIController.Items.forEach((item, index) => {
