System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, screen, Widget, Vec3, Constants, UIController, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _temp, _crd, ccclass, property, Responsive;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Responsive", Responsive = (_dec = ccclass('Responsive'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(_crd && UIController === void 0 ? (_reportPossibleCrUseOfUIController({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "text_fail", _descriptor4, this);

          _initializerDefineProperty(this, "UIController", _descriptor5, this);
        ...
        setHorizontalForIpX() {
          ...
          this.text.getComponent(Widget).isAbsoluteTop = true;
          this.text.getComponent(Widget).isAlignTop = true;
          this.text.getComponent(Widget).isAbsoluteBottom = false;
          this.text.getComponent(Widget).isAlignBottom = false;
          this.text.getComponent(Widget).bottom = 0;

          if (screen.windowSize.height / screen.windowSize.width > 0.55) {
            // Ip 6 / 6Plus / 7 / 7 Plus
            this.UI.setScale(new Vec3(0.35, 0.35, 0.35)); // this.UI.setPosition(new Vec3(0, -30, 0))

            this.text.setScale(new Vec3(0.4, 0.4, 0.4));
            this.text_fail.setScale(new Vec3(0.3, 0.3, 0.3));
            this.text_fail.setPosition(new Vec3(0, 20, 0));
            this.Armo.setScale(new Vec3(0.5, 0.5, 0.5));
            this.Armo.setPosition(new Vec3(50, -40, 0));
            this.text.getComponent(Widget).top = 8;
            console.log(1);
          } else {
            // IpX
            this.UI.setScale(new Vec3(0.3, 0.3, 0.3)); // this.UI.setPosition(new Vec3(0, -30, 0))
        ...
        setIphoneX() {
          ...
          this.text.setScale(new Vec3(1, 1, 1));
          this.text_fail.setScale(new Vec3(0.6, 0.6, 0.6));
          this.text_fail.setPosition(new Vec3(0, 110, 0));
          this.Armo.setScale(new Vec3(1, 1, 1));
          this.Armo.setPosition(new Vec3(0, 0, 0));
          this.text.getComponent(Widget).isAbsoluteTop = false;
          this.text.getComponent(Widget).isAlignTop = false;
          this.text.getComponent(Widget).isAbsoluteBottom = true;
          this.text.getComponent(Widget).isAlignBottom = true;
          this.text.getComponent(Widget).bottom = 20;
          console.log(4);
        }
        ...
        setMobile() {
          ...
          this.Armo.setScale(new Vec3(1, 1, 1));
          this.Armo.setPosition(new Vec3(0, 0, 0));
          this.text.getComponent(Widget).top = 20; // if (screen.windowSize.width / screen.windowSize.height < 0.7) {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "text_fail", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
