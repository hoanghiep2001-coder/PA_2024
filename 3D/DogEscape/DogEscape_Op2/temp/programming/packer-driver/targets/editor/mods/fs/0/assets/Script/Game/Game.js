System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Vec3, CCFloat, v3, screen, Animation, GameController, JoyStick, Constants, AudioManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _temp, _crd, ccclass, property, Game;
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass("Game"), _dec2 = property(_crd && JoyStick === void 0 ? (_reportPossibleCrUseOfJoyStick({
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "CTA_btn", _descriptor15, this);

          _initializerDefineProperty(this, "CTA_tryBtn", _descriptor16, this);

          _initializerDefineProperty(this, "CTA_Download", _descriptor17, this);
        ...
        reset() {
          ...
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).isEatFood = false; // mtg & applovin
        ...
        EndGame(bool) {
          this.CTA.active = true; // Constants.ironSource.isEndGame = true;

          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).isCatched ? this.CTA.getComponent(Animation).play("CTA_Anim") : this.CTA.getComponent(Animation).play("CTA_Anim_NoLose");
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "CTA_btn", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "CTA_tryBtn", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "CTA_Download", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
