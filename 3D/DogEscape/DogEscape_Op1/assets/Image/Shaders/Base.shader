...
Shader "SmasherVisual/Base"
{
	...
	[TCP2HeaderHelp(SILHOUETTE)]
		[MaterialToggle] _EnableSilhouette("Enable silhouette", Float) = 0
		_SilhouetteColor ("Color (RGB) Opacity (A)", Color) = ( 0.3820755,0.9381145,1,1)
	[TCP2Separator]
