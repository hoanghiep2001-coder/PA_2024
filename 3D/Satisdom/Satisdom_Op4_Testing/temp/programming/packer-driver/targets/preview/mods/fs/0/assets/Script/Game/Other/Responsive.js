System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, screen, Constants, GamePlay, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, _crd, ccclass, property, Responsive;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GamePlay = _unresolved_3.GamePlay;
    }],
    execute: function () {
      _crd = true;
