    ...
    execute: function () {
      ...
      _export("GamePlay", GamePlay = (_dec = ccclass('GamePlay'), _dec2 = property(_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
        ...
        getColorStatus(colors) {
          let firstColorOfTube = null;
          let indexOfFirstColor = null;
          let nonTransparentColorArr = [];
          let heightOfFirstColor = null;
          let colorHeightArr = [900, 450, 200];
          let isHasTwoSameColor = false;
        ...
        handleMoveToAnotherTube(tubeA, tubeB) {
          const tubeABottleItemComp = tubeA.getComponent(_crd && BottleItem === void 0 ? (_reportPossibleCrUseOfBottleItem({
            error: Error()
          }), BottleItem) : BottleItem);
          const tubeBBottleItemComp = tubeB.getComponent(_crd && BottleItem === void 0 ? (_reportPossibleCrUseOfBottleItem({
            error: Error()
          }), BottleItem) : BottleItem);
        ...
        calculateNewTubeState(tubeBBottleItemComp, tubeABottleItemComp) {
          ...
          const tubeBpos = tubeBBottleItemComp.node.getPosition();
          const colorStatus = this.getColorStatus(tubeABottleItemComp.waterColors);
