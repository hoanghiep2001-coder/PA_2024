System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Color, Component, BottleItem, _dec, _dec2, _dec3, _class, _class2, _descriptor, _temp, _crd, ccclass, property, ColorController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ColorController", ColorController = (_dec = ccclass('ColorController'), _dec2 = _decorator.executeInEditMode, _dec3 = property([_crd && BottleItem === void 0 ? (_reportPossibleCrUseOfBottleItem({
        error: Error()
      }), BottleItem) : BottleItem]), _dec(_class = _dec2(_class = (_class2 = (_temp = class ColorController extends Component {
        constructor(...args) {
          super(...args);
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "BottleItems", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
