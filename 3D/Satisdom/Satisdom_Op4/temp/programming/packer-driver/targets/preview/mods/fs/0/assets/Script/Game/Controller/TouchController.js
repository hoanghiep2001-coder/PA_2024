    ...
    execute: function () {
      ...
      _export("TouchController", TouchController = (_dec = ccclass('TouchController'), _dec2 = property(_crd && GamePlay === void 0 ? (_reportPossibleCrUseOfGamePlay({
        ...
        isPickCorrectTube(tube1, tube2) {
          var reuslt = false;
          var tube1BottleItemComponent = tube1.getComponent(_crd && BottleItem === void 0 ? (_reportPossibleCrUseOfBottleItem({
            error: Error()
          }), BottleItem) : BottleItem);
          var tube2BottleItemComponent = tube2.getComponent(_crd && BottleItem === void 0 ? (_reportPossibleCrUseOfBottleItem({
            error: Error()
          }), BottleItem) : BottleItem);
