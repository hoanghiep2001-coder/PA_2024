System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Color, Component, Graphics, BottleItem, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, executeInEditMode, TubeController;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "83117W9E+1POLMuSfQsWekM", "TubeController", undefined);
      ...
      _export("TubeController", TubeController = (_dec = ccclass('TubeController'), _dec2 = property([_crd && BottleItem === void 0 ? (_reportPossibleCrUseOfBottleItem({
        error: Error()
      }), BottleItem) : BottleItem]), _dec3 = property(Graphics), _dec(_class = executeInEditMode(_class = (_class2 = (_temp = class TubeController extends Component {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=TubeController.js.map