System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, screen, GamePlay, Constants, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, _crd, ccclass, property, Responsive;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Responsive", Responsive = (_dec = ccclass('Responsive'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(_crd && GamePlay === void 0 ? (_reportPossibleCrUseOfGamePlay({
        error: Error()
      }), GamePlay) : GamePlay), _dec(_class = (_class2 = (_temp = class Responsive extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "TopBG", _descriptor, this);

          _initializerDefineProperty(this, "BotBG", _descriptor2, this);
        ...
        setHorizontalForIpX() {
          ...
          this.BotBG.active = false; // this.TopBG.setPosition(0, 300, 0);
        ...
        setIphoneX() {
          ...
          this.BotBG.setPosition(0, -331, 0); // 332 335 345 
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "TopBG", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "BotBG", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
