...
export class Constants {
    ...
    static isTouchSixthBtn: boolean = false;
    static isTouchSeventhBtn: boolean = false;
    static isTouchEighthBtn: boolean = false;
    static isTouchNinthBtn: boolean = false;
    static isTouchTenthBtn: boolean = false;
