...
export default class Responsive extends Component {
    ...
    protected start(): void {
        this.CTA_logo = this.CTA.getChildByName("img_game_title2");
        this.CTA_icon = this.CTA.getChildByName("Icon");
        this.CTA_btn = this.CTA.getChildByName("Button");
    ...
    private setHorizontalForIpX(): void {
        ...
        this.CTA_btn.setPosition(0, -540.478, 0);
        this.CTA_logo.setPosition(0, 206.921, 0);
    }
    ...
    private setIphoneX(): void {
        ...
        this.CTA_btn.setPosition(0, -620.478, 0);
        this.CTA_logo.setPosition(0, 280.921, 0);
    }
