  ...
  return {
    ...
    execute: function () {
      ...
      _export("GamePlay", GamePlay = (_dec = ccclass('GamePlay'), _dec2 = property(_crd && NodesController === void 0 ? (_reportPossibleCrUseOfNodesController({
        ...
        unActiveNuggets() {
          for (var index = 1; index < this.NodesController.Nuggets.length; index++) {
            var nugget = this.NodesController.Nuggets[index];
            nugget.active = false;
          }
        }
        ...
        checkMerge() {
          for (var i = 0; i < this.NodesController.Points.length; i++) {
            var currentNode = this.NodesController.Points[i];
            ...
            if (nodeBdx.intersects(pointBdx)) {
              ...
              for (var j = 0; j < (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
                ...
                if (!(_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                  ...
                  var stateArr = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                    error: Error()
                  }), Constants) : Constants).mergeStatus.filter(state => state === true);
                  var arrayOf4 = stateArr.slice(0, 5);
        ...
        merge() {
          ...
          var _loop = function _loop(index) {
            var nugget5Pos = _this.NodesController.Nuggets[4].getPosition();

            var nugget = _this.NodesController.Nuggets[index];
            ...
            if (!nugget.name.includes("5")) {
              tween(nugget).to(1, {
                ...
                nugget.active = false;
                _this.inPosMergeState += 1;
              }).start();
            }
          };

          for (var index = 0; index < this.NodesController.Nuggets.length; index++) {
            _loop(index);
          }
        }
        ...
        showSkibidiNugget() {
          ...
          var SkibidiNugget = this.NodesController.SkibidiNugget;
        ...
        resetNuggetMerge(active) {
          for (var index = 0; index < this.NodesController.NuggetLines.length; index++) {
            var node = this.NodesController.NuggetLines[index];
            node.active = active;
          }
