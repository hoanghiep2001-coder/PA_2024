    ...
    execute: function () {
      ...
      _export("AudioManager", AudioManager = (_dec = ccclass('AudioManager'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property(AudioSource), _dec5 = property(AudioSource), _dec6 = property(AudioSource), _dec7 = property(AudioSource), _dec8 = property(AudioSource), _dec9 = property(AudioSource), _dec10 = property(AudioSource), _dec(_class = (_class2 = (_temp = class AudioManager extends Component {
        constructor() {
          ...
          _initializerDefineProperty(this, "NuggetSound", _descriptor8, this);

          _initializerDefineProperty(this, "BoomSound", _descriptor9, this);
        }
        ...
        switchVolume(soundName, volume) {
          switch (soundName) {
            ...
            case "NuggetSound":
              this.NuggetSound.volume = volume;
              break;
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "NuggetSound", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "BoomSound", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
