System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, ERigidBodyType, math, Node, SkeletalAnimation, Constants, AudioManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, CharacterControl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1bd289XcFNIQoFVF9TBD+RL", "CharacterControl", undefined);
      ...
      _export("CharacterControl", CharacterControl = (_dec = ccclass('CharacterControl'), _dec2 = property(_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
        ...
        start() {
          this.getComponent(SkeletalAnimation).play("Idle_2"); // this.node.setScale(new Vec3(0, 0, 0));
