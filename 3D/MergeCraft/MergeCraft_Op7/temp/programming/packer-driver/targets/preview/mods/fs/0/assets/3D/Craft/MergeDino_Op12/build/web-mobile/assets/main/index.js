            ...
            return {
              ...
              execute: function execute() {
                ...
                e("GameController", (d = m("GameController"), p = g(l), d((f = o((y = function (e) {
                  function o() {
                    for (var o, n = arguments.length, s = new Array(n), a = 0; a < n; a++) {
                      s[a] = arguments[a];
                    }
          ...
          System.register("chunks:///_virtual/Utils.ts", ["./_rollupPluginModLoBabelHelpers.js", "cc", "./Constant.ts"], function (e) {
            ...
            return {
              ...
              execute: function execute() {
                ...
                var c = {
                  checkMergeFirstStep: function checkMergeFirstStep() {
                  ...
                  checkMergeSecondStep: function checkMergeSecondStep() {
                    ...
                    a = {
                  mergeDinoStep1: function mergeDinoStep1(e) {
                    o(e).to(.4, {
                  ...
                  mergeDinoStep2: function mergeDinoStep2(e) {
                    o(e).to(.4, {
            ...
            return {
              ...
              execute: function execute() {
                ...
                t("Responsive", (_ = B("Responsive"), N = w(c), _((I = o((p = function (t) {
                  function o() {
                    for (var o, e = arguments.length, i = new Array(e), r = 0; r < e; r++) {
                      i[r] = arguments[r];
                    }
            ...
            return {
              ...
              execute: function execute() {
                ...
                o("IronSource", (s = f("IronSource"), d = y(S), s((g = n((p = function (o) {
                  function n() {
                    for (var n, r = arguments.length, u = new Array(r), a = 0; a < r; a++) {
                      u[a] = arguments[a];
                    }
            ...
            return {
              ...
              execute: function execute() {
                ...
                o("AudioManager", (d = w("AudioManager"), c = L(s), l = L(s), D = L(s), _ = L(s), h = L(s), p = L(s), b = L(s), d((f = n((k = function (o) {
                  function n() {
                    for (var n, e = arguments.length, u = new Array(e), a = 0; a < e; a++) {
                      u[a] = arguments[a];
                    }
