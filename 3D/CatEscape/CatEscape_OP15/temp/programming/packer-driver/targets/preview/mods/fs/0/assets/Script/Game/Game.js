System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Vec3, CCFloat, v3, screen, Animation, GameController, JoyStick, Constants, AudioManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _temp, _crd, ccclass, property, Game;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass("Game"), _dec2 = property(_crd && JoyStick === void 0 ? (_reportPossibleCrUseOfJoyStick({
        ...
        error: Error()
      }), AudioManager) : AudioManager), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(CCFloat), _dec20 = property(CCFloat), _dec(_class = (_class2 = (_temp = class Game extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "clock", _descriptor13, this);

          _initializerDefineProperty(this, "timeline", _descriptor14, this);

          _initializerDefineProperty(this, "HideMask", _descriptor15, this);

          _initializerDefineProperty(this, "CTA", _descriptor16, this);

          _initializerDefineProperty(this, "CTA_tryBtn", _descriptor17, this);

          _initializerDefineProperty(this, "CTA_Download", _descriptor18, this);

          _initializerDefineProperty(this, "_realHeight", _descriptor19, this);

          _initializerDefineProperty(this, "_realWidth", _descriptor20, this);
        ...
        EndGame(bool) {
          ...
          this.clock.active = false; // mtg & applovin
        ...
        managerScene(e) {
          ...
          if (this.step === 2) {
            ...
            var localPos = new Vec3(pos.x - 160, pos.y - 240, 0); // if (this.ironSourceSoundState) {
            //   this.click.play();
            // }
        ...
        update(deltaTime) {
          ...
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            error: Error()
          }), Constants) : Constants).ironSource.isEndGame && this.handleCountingTime();
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "clock", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "timeline", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "HideMask", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "CTA", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "CTA_tryBtn", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "CTA_Download", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "_realHeight", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "_realWidth", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
