...
export default class AudioManager extends Component {
    ...
    public stopAllSound(): void {
        this.bgSound.stop();
        this.catAngrySound.stop(); this.electricSound.stop(); this.electric2Sound.stop(); this.winSound.stop(); this.loseSound.stop(); this.eatSound.stop();      this.clockSound.stop();
    }
}
