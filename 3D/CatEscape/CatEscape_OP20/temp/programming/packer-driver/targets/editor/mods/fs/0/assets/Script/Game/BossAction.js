System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, tween, Quat, Vec3, SkeletalAnimation, RigidBody, Collider, Constants, Game, AudioManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, BossAction;
    ...
    execute: function () {
      ...
      _export("BossAction", BossAction = (_dec = ccclass("BossAction"), _dec2 = property(_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
        ...
        runTweenOfBossFirstScene() {
          this.tweenState = tween(this.node).by(2.6, {
        ...
        runTweenOfBossSecondScene() {
          this.tweenState = tween(this.node).by(1.5, {
