  ...
  return {
    ...
    execute: function () {
      ...
      _export("LaserController", LaserController = (_dec = ccclass('LaserController'), _dec2 = property(_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
        error: Error()
      }), AudioManager) : AudioManager), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property([ParticleSystem]), _dec(_class = (_class2 = (_temp = class LaserController extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "AudioManager", _descriptor, this);

          _initializerDefineProperty(this, "wallLaser_1", _descriptor2, this);

          _initializerDefineProperty(this, "wallLaser_2", _descriptor3, this);

          _initializerDefineProperty(this, "Laser", _descriptor4, this);

          _initializerDefineProperty(this, "LaserBtn_Red", _descriptor5, this);

          _initializerDefineProperty(this, "LaserBtn_Blue", _descriptor6, this);

          _initializerDefineProperty(this, "wallLaserBtn_Red", _descriptor7, this);

          _initializerDefineProperty(this, "wallLaserBtn_Blue", _descriptor8, this);

          _initializerDefineProperty(this, "Fx_Lightning", _descriptor9, this);
        ...
        start() {
          this.schedule(() => {
            if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).isForceActiveLaser) return;
            this.activeLaser();
            this.scheduleOnce(() => {
              this.unActiveLaser();
            }, 1);
        ...
        activeLaser() {
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).laser = true;
          this.laserFlag = true;
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "wallLaser_1", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "wallLaser_2", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "Laser", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "LaserBtn_Red", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "LaserBtn_Blue", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "wallLaserBtn_Red", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "wallLaserBtn_Blue", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "Fx_Lightning", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
