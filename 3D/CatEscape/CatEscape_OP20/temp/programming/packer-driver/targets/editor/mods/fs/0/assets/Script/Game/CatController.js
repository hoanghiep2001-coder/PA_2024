System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, RigidBody, v3, CCString, SkeletalAnimation, Vec3, Vec2, BoxCollider, JoyStick, Game, Constants, AudioManager, LaserController, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _temp, _crd, ccclass, property, CatController;
  ...
  function _reportPossibleCrUseOfLaserController(extras) {
    _reporterNs.report("LaserController", "./LaserController", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      LaserController = _unresolved_6.LaserController;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("CatController", CatController = (_dec = ccclass("CatController"), _dec2 = property(_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
        error: Error()
      }), AudioManager) : AudioManager), _dec3 = property(_crd && JoyStick === void 0 ? (_reportPossibleCrUseOfJoyStick({
        error: Error()
      }), JoyStick) : JoyStick), _dec4 = property(_crd && LaserController === void 0 ? (_reportPossibleCrUseOfLaserController({
        error: Error()
      }), LaserController) : LaserController), _dec5 = property(_crd && Game === void 0 ? (_reportPossibleCrUseOfGame({
        error: Error()
      }), Game) : Game), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(RigidBody), _dec9 = property(CCString), _dec10 = property(SkeletalAnimation), _dec(_class = (_class2 = (_temp = class CatController extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "LaserController", _descriptor3, this);

          _initializerDefineProperty(this, "GamePlay", _descriptor4, this);

          _initializerDefineProperty(this, "Door1", _descriptor5, this);

          _initializerDefineProperty(this, "laserPoint", _descriptor6, this);

          _initializerDefineProperty(this, "_body", _descriptor7, this);

          _initializerDefineProperty(this, "catDirectionMove", _descriptor8, this);

          _initializerDefineProperty(this, "_aniSkeleton", _descriptor9, this);
        ...
        handleCollide() {
          ...
          this.collider.on("onCollisionEnter", e => {
            // if(e.otherCollider.node.name.startsWith("break_wall")) {
            //   if(this.rigidbody) this.rigidbody.destroy();
            ...
            if (e.otherCollider.node.name === "Vision" && (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              ...
              (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              }), Constants) : Constants).bossCatchedName = e.otherCollider.node.parent.name;
        ...
        handleAngleCat() {
          ...
          let newPos = new Vec2(joyStickPos.x, joyStickPos.y);
        ...
        caculateDistanceToActiveLaser() {
          const x = Vec3.distance(this.node.getPosition(), this.laserPoint.getPosition());

          if (x <= 1) {
            (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).isForceActiveLaser = true;
            this.LaserController.activeLaser();
          }
        }
        ...
        update(deltaTime) {
          ...
          !this.isElectricFlag && this.caculateDistanceToActiveLaser();
        }
        ...
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "LaserController", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
        ...
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "Door1", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "laserPoint", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "_body", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "catDirectionMove", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "_aniSkeleton", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
