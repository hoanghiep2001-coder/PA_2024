System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, BoxCollider, Component, ERigidBodyType, math, Node, RigidBody, SkeletalAnimation, Vec3, Constants, AudioManager, NodesController, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, _crd, ccclass, property, CharacterControl;
      ...
      _export("CharacterControl", CharacterControl = (_dec = ccclass('CharacterControl'), _dec2 = property(_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
        ...
        start() {
          ...
          this.collider.on("onCollisionEnter", e => {
            if (e.otherCollider.node.name === "Robo_Boss") {
              ...
              this.node.name === "Robo" ? (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              ...
              this.scheduleOnce(() => {
                ...
                this.scheduleOnce(() => {
                  this.AudioManager.playSound((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                    error: Error()
                  }), Constants) : Constants).SoundTrack.ExplosionSound);
                }, 1.2);
              }, 2);
            }
          });
        ...
        update(dt) {
          if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).isFightStep1 && !this.isFight && this.node.name === "Robo") {
            this.Run();
          }
