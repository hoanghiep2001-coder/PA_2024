System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("NodesController", NodesController = (_dec = ccclass('NodesController'), _dec2 = property(Camera), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(ParticleSystem), _dec9 = property(ParticleSystem), _dec10 = property(ParticleSystem), _dec11 = property(ParticleSystem), _dec12 = property(ParticleSystem), _dec13 = property([Node]), _dec14 = property([Node]), _dec15 = property([Node]), _dec16 = property([Node]), _dec17 = property([Node]), _dec18 = property([Node]), _dec19 = property([Node]), _dec20 = property([Node]), _dec21 = property(Node), _dec22 = property(Node), _dec23 = property(Node), _dec24 = property(Node), _dec25 = property(Node), _dec26 = property(Node), _dec(_class = (_class2 = (_temp = class NodesController extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "FX_FireBall1", _descriptor9, this);

          _initializerDefineProperty(this, "FX_FireBall2", _descriptor10, this);

          _initializerDefineProperty(this, "FX_FireBall3", _descriptor11, this);

          _initializerDefineProperty(this, "dinoLines", _descriptor12, this);

          _initializerDefineProperty(this, "points_1", _descriptor13, this);

          _initializerDefineProperty(this, "points_2", _descriptor14, this);

          _initializerDefineProperty(this, "unitsStep1", _descriptor15, this);

          _initializerDefineProperty(this, "unitstep2", _descriptor16, this);

          _initializerDefineProperty(this, "dinoLevels", _descriptor17, this);

          _initializerDefineProperty(this, "dinosStep1", _descriptor18, this);

          _initializerDefineProperty(this, "dinosStep2", _descriptor19, this);

          _initializerDefineProperty(this, "Boss", _descriptor20, this);

          _initializerDefineProperty(this, "MainCharacter_1", _descriptor21, this);

          _initializerDefineProperty(this, "targetNode", _descriptor22, this);

          _initializerDefineProperty(this, "MainCharacter_2", _descriptor23, this);

          _initializerDefineProperty(this, "Text_Tap", _descriptor24, this);

          _initializerDefineProperty(this, "Fail", _descriptor25, this);
        ...
        setupForUtils() {
          ...
          var copyDinoLines = this.dinoLines.slice(0, 8);
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          var pointsCopy2 = [...this.points_2];
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).points_2 = pointsCopy2;
          var copyDinoLines_2 = this.dinoLines.slice(8, 14);
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        saveUnitsInitPos() {
          ...
          for (var i = 0; i < this.unitsStep1.length; i++) {
            var unitPos = this.unitsStep1[i].getPosition();
            var dino = this.unitsStep1[i].getChildByName("Robo_" + (i + 1));
          ...
          for (var _i = 0; _i < this.unitstep2.length; _i++) {
            var _unitPos = this.unitstep2[_i].getPosition();

            var _dino = this.unitstep2[_i].getChildByName("Robo_" + (_i + 9));

            var _pos = _dino.getPosition();

            dinosStep2Pos.push(_pos);
            unitsStep2Pos.push(_unitPos);
          }
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "FX_FireBall1", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "FX_FireBall2", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "FX_FireBall3", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "dinoLines", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "points_1", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "points_2", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "unitsStep1", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "unitstep2", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "dinoLevels", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "dinosStep1", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "dinosStep2", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "Boss", [_dec21], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, "MainCharacter_1", [_dec22], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, "targetNode", [_dec23], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, "MainCharacter_2", [_dec24], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor24 = _applyDecoratedDescriptor(_class2.prototype, "Text_Tap", [_dec25], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor25 = _applyDecoratedDescriptor(_class2.prototype, "Fail", [_dec26], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
