    ...
    execute: function () {
      ...
      _export("reuseList", reuseList = (_dec = ccclass("reuseList"), _dec2 = menu('自定义组件/reuseList'), _dec3 = requireComponent(ScrollViewComponent), _dec4 = property({
        ...
        init(datas) {
          ...
          const size = (_this$node$getCompone = this.node.getComponent(UITransformComponent)) === null || _this$node$getCompone === void 0 ? void 0 : _this$node$getCompone.contentSize;
        ...
        getPositionInView(position) {
          ...
          const worldPos = (_this$content$getComp4 = this.content.getComponent(UITransformComponent)) === null || _this$content$getComp4 === void 0 ? void 0 : _this$content$getComp4.convertToWorldSpaceAR(position);
          const viewPos = (_this$node$getCompone2 = this.node.getComponent(UITransformComponent)) === null || _this$node$getCompone2 === void 0 ? void 0 : _this$node$getCompone2.convertToNodeSpaceAR(worldPos);
          return viewPos;
        }
        ...
        isOverBorder(viewPos) {
          ...
          const size = (_this$node$getCompone3 = this.node.getComponent(UITransformComponent)) === null || _this$node$getCompone3 === void 0 ? void 0 : _this$node$getCompone3.contentSize;
          const {
            height
          } = size;
        ...
        doLayout() {
          ...
          const size = (_this$node$getCompone4 = this.node.getComponent(UITransformComponent)) === null || _this$node$getCompone4 === void 0 ? void 0 : _this$node$getCompone4.contentSize;
          let i = 0;
