System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Vec3, UITransform, ParticleSystem, Constants, NodesController, GameController, AudioManager, IronSource, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, TouchAreaController;
    ...
    execute: function () {
      ...
      _export("TouchAreaController", TouchAreaController = (_dec = ccclass("TouchAreaController"), _dec2 = property(_crd && IronSource === void 0 ? (_reportPossibleCrUseOfIronSource({
        ...
        registerEvent() {
          ...
          this.NodesController.CTA_btn.on(Node.EventType.TOUCH_START, this.GameController.installHandle, this); // mtg & applovin
        ...
        touchStart() {
          ...
          if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).GameData.touchPointCount === 2) {
            (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).GameData.touchPointCount += 1;
        ...
        touchMove(event) {
          ...
          var touchPos = this.convertToLocalLocation(event.getUILocation());
        ...
        handleCollideOtherPoint() {
          var pointBdx = this.NodesController.movingPoint.getComponent(UITransform).getBoundingBox();
          this.handleCollideStep1(pointBdx);
        }

        handleCollideStep1(pointBdx) {
          for (var index = 0; index < this.NodesController.points.length; index++) {
            var point = this.NodesController.points[index];
            var otherPointBdx = point.getComponent(UITransform).getBoundingBox();
            if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            }), Constants) : Constants).GameData.roboTouchingNumber !== index && pointBdx.intersects(otherPointBdx)) this.activeCurrentRoboWithTouch(index);
          }
        }

        activeCurrentRoboWithTouch(index) {
          this.AudioManager.playSound((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).SoundTrack.chooseSound);
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).GameData.roboTouchingNumber = index;
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).GameData.touchPointCount += 1;
          var robo = this.NodesController.robo_Step1[index];
          var roboFXs = robo.getComponentsInChildren(ParticleSystem);
          var roboArownDown = robo.getChildByName("Arrown");
          roboFXs.forEach(fx => fx.play());
          roboArownDown.active = true;
          if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).GameData.touchPointCount === 2) (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).GameData.isDoneStep1 = true;
        }
