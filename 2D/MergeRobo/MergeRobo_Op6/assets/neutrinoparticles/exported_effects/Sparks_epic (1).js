...
(function (root, factory) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        define(['exports'], function (exports) {
            (root.NeutrinoEffect = exports)['Sparks_epic__1_'] = factory();
        });
    } else {
        var namespace = (root.NeutrinoEffect || (root.NeutrinoEffect = {}));
        namespace.__last__ = namespace['Sparks_epic__1_'] = factory();
    }
}(typeof self !== 'undefined' ? self : this, function () {

function Sparks_epic__1_(ctx) {
	var Db = this;
	...
	function Emitter_DefaultEmitter() {
		...
		var _1, _2 = [], _2i, _2s = [], _3, _4 = [], _6 = [], _8 = [], _8i0, _8s0 = [], _8i1, _8s1 = [], _8i2, _8s2 = [], _10, _12, _13, _14 = [], _16, _18, _19, _19i0, _19s0 = [], _20=[], _20a=[], _20i=[], _21=[], _21fs=[], _21vs=[], _21rw=[], _21rwn=[], _21rwl, _21v=[], _21p=[], _21dtl, _21dtp, _21df, _21fsd=[], _22=[], _22x=[], _22y=[], _22z=[], _23, _24 = [], _24i0, _24s0 = [], _24i1, _24s1 = [], _25, _26 = [], _26i0, _26s0 = [], _26i1, _26s1 = [], _26i2, _26s2 = [], _27, _27i0, _27s0 = [];
