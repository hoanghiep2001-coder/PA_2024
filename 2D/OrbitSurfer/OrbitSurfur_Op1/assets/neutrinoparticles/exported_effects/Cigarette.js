...
function Cigarette(ctx) {
	...
	function Emitter_DefaultEmitter() {
		...
		var _1, _2 = [], _2i, _2s = [], _3 = [], _5, _6 = [], _6i, _6s = [], _7 = [], _9, _11, _12, _13 = [], _13i0, _13s0 = [], _13i1, _13s1 = [], _13i2, _13s2 = [], _14, _14i0, _14s0 = [], _15=[], _15a=[], _15i=[], _16=[], _16fs=[], _16vs=[], _16rw=[], _16rwn=[], _16rwl, _16v=[], _16p=[], _16dtl, _16dtp, _16df, _16fsd=[], _17, _18, _18i0, _18s0 = [], _19, _20, _20i0, _20s0 = [];
		...
		this.ud = function(Bd) {
			Bd.dd();
			Bd._2 = [
				[[-4.67432,2.25574],[4.79819,2.25574],[4.79819,2.25574]]
			];
			Bd._6 = [
				[[-3.14021,-46.509],[8.87581,-46.3798],[8.87581,-46.3798]]
			];
			Bd._13 = [
				[
					[0,300,300]
				...
				[
					[-800,-604.339,-467.578,-364.595,-284.193,-220.208,-168.805,-127.398,-94.1339,-67.6183,-46.7594,-30.6685,-18.5932,-9.86816,-3.87458,0,0]
				],
				[
					[0,0,0]
				]
			...
			Bd._14 = [
				[
					[200,292.426,364.042,419.226,461.403,493.309,517.178,534.853,547.883,557.584,565.086,571.366,577.283,583.592,590.964,600,600]
				]
			];
			Bd._18 = [
				[
					[0.5,0.572555,0.703337,0.891427,1.13639,1.43827,1.79756,2.21527,2.69291,3.23262,3.83719,4.51023,5.25633,6.08134,6.9927,8,8]
				]
			];
			Bd._20 = [
				[
