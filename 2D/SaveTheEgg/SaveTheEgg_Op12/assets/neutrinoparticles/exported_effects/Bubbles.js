...
function Bubbles(ctx) {
	...
	function Emitter_DefaultEmitter() {
		...
		var _1, _3, _4 = [], _4i, _4s = [], _5, _6 = [], _9, _9i0, _9s0 = [], _11, _11i0, _11s0 = [], _12, _13, _14=[], _14a=[], _14i=[], _15, _15i0, _15s0 = [], _16=[], _16a=[], _16i=[], _17=[], _17fs=[], _17vs=[], _17rw=[], _17rwn=[], _17rwl, _17v=[], _17p=[], _17dtl, _17dtp, _17df, _17fsd=[], _19, _19i0, _19s0 = [], _20, _21, _21i0, _21s0 = [], _18, _22, _23, _23i0, _23s0 = [], _24, _25, _25i0, _25s0 = [];
		this.pe = [{xe:0,Rc:8,Sc:1,renderStyleIndex:0}];
		this.name = "DefaultEmitter";

		this.ud = function(Bd) {
			Bd.dd();
			Bd._4 = [
				[[-69.7778,597.194],[-11.7124,597.628],[46.354,597.847],[104.423,597.967],[162.495,598.028],[220.562,598.054],[278.633,598.057],[336.702,598.048],[394.77,598.035],[452.839,598.026],[510.91,598.03],[568.977,598.055],[627.048,598.117],[685.118,598.236],[743.184,598.456],[801.25,598.889],[801.25,598.889]]
			];
			Bd._9 = [
				[
					[5.07027,15.7745,15.7745]
				]
			];
			Bd._11 = [
				[
			...
			Bd._15 = [
				[
					[0,4.3328,25.796,65.888,125.577,204.724,301.348,411.012,526.867,640.732,744.903,833.676,903.891,954.566,986.181,1000,1000]
				]
			];
			Bd._19 = [
				[
