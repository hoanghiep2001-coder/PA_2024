...
function Fireworks01(ctx) {
	...
	function Emitter_Stripe_child() {
		...
		this.ud = function(Bd) {
			...
			Bd._18 = [
				[
					[0,2.0657,2.78929,3.28572,3.66181,3.95916,4.1992,4.39469,4.55401,4.68298,4.78584,4.86582,4.92541,4.96661,4.99103,5,5]
				]
			];
			Bd.jd = 300;
			Bd.Vc = 0;
	...
	function Emitter_Stripe_parent() {
		...
		var _1 = [], _3, _5 = [], _7=[], _7x=[], _7y=[], _7z=[], _8, _8i0, _8s0 = [], _9 = [], _10=[], _10fs=[], _10vs=[], _10rw=[], _10rwn=[], _10rwl, _10v=[], _10p=[], _10dtl, _10dtp, _10df, _10fsd=[], _11;
		this.pe = [];
		...
		this.ud = function(Bd) {
			...
			Bd._8 = [
				[
					[0,0.0314964,0.136246,0.328507,0.59644,0.890682,1.16035,1.38407,1.56152,1.69908,1.80373,1.88132,1.93649,1.97287,1.9933,2,2]
				]
			];
			Bd.jd = 100;
			Bd.Vc = 0;
	...
	function Emitter_Sparks() {
		...
		var _, _i0, _s0 = [], _2 = [], _4, _6, _8, _10, _12 = [], _14=[], _15, _16, _17, _17i0, _17s0 = [], _18, _19;
		this.pe = [{xe:0,Rc:2,Sc:3,renderStyleIndex:1}];
		this.name = "Sparks";
		...
		this.ud = function(Bd) {
			...
			Bd._17 = [
				[
					[0,0.149709,0.460975,0.803237,1.08303,1.29919,1.46717,1.59926,1.7039,1.7869,1.85236,1.90328,1.94194,1.97007,1.98906,2,2],
					[2,1.66994,1.37363,1.11535,0.895215,0.710443,0.556908,0.430206,0.326245,0.241465,0.172875,0.118,0.0748067,0.0416215,0.0170665,0,0],
					[0,0.822571,0.822571],
					[0.822571,0.230368,0.230368],
					[0.230368,0.7,0.7],
					[0.7,0,0],
					[0,0.6,0.6],
					[0.6,0,0]
	...
	function Emitter_Splash() {
		...
		var _1 = [], _5, _4, _6, _7, _7i0, _7s0 = [], _8, _9;
		this.pe = [{xe:0,Rc:5,Sc:3,renderStyleIndex:0}];
		this.name = "Splash";
		...
		this.ud = function(Bd) {
			...
			Bd._7 = [
				[
					[0,1,1],
					[1,0.990835,0.969351,0.938093,0.898586,0.851781,0.798265,0.738368,0.672217,0.599762,0.520766,0.43479,0.341128,0.238703,0.125869,0,0]
				]
			];
			Bd.jd = 100;
			Bd.Vc = 0;
	...
	function Emitter_Fireworks_parent() {
		...
		this.ud = function(Bd) {
			Bd._ = [
				[
					[1.47301,1.47301,1.47301],
					[0,0,0]
				]
			];
			Bd.dd();
			Bd._3 = [
				[[-383.168,98.272],[-383.168,-101.728],[-383.168,-101.728]]
			];
			Bd._4 = [
				[[405.632,91.36],[405.632,-108.64],[405.632,-108.64]]
			];
			Bd._11 = [
				[
					[0,0,0],
			...
			Bd.uc(new Emitter_Splash(), { xc: 1, sd: false });
			Bd.jd = 3;
			Bd.Vc = 0;
		}
