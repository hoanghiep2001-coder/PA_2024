...
function Blast03(ctx) {
	...
	this.materials = [1,0];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]},{materialIndex:0,textureIndices:[1]},{materialIndex:0,textureIndices:[2]},{materialIndex:0,textureIndices:[3]},{materialIndex:1,textureIndices:[4]}];
	this.Xe = 500;

	function Emitter_Blast() {

		var _, _i0, _s0 = [], _2 = [], _4 = [], _6, _8, _9 = [], _9i0, _9s0 = [], _9i1, _9s1 = [], _9i2, _9s2 = [], _11=[], _13, _12, _14, _15, _15i0, _15s0 = [], _16, _16i0, _16s0 = [];
		this.pe = [{xe:0,Rc:8,Sc:8,renderStyleIndex:0}];
		this.name = "Blast";
		...
		this.ud = function(Bd) {
			...
			Bd._9 = [
				...
				[
					[0.319595,0.635811,0.635811]
				],
				[
					[0.208108,0.208108,0.208108]
				]
			];
			Bd._15 = [
				[
	...
	function Emitter_Shockwave() {
		...
		var _1 = [], _5, _4, _6, _7, _7i0, _7s0 = [], _8, _9, _9i0, _9s0 = [];
		...
		this.ud = function(Bd) {
			...
			Bd._7 = [
				[
					[0,0.0479595,0.10855,0.179953,0.259913,0.345832,0.434909,0.524314,0.611351,0.693599,0.769009,0.835944,0.893186,0.9399,0.975581,1,1]
				]
			];
			Bd._9 = [
				[
	...
	function Emitter_Sparks() {
		...
		var _1, _3 = [], _5, _6 = [], _8, _9, _10 = [], _12 = [], _13=[], _13fs=[], _13vs=[], _13rw=[], _13rwn=[], _13rwl, _13v=[], _13p=[], _13dtl, _13dtp, _13df, _13fsd=[], _14=[], _14x=[], _14y=[], _14z=[], _15, _16 = [], _16i0, _16s0 = [], _16i1, _16s1 = [], _17, _18 = [], _18i0, _18s0 = [], _18i1, _18s1 = [], _18i2, _18s2 = [];
		this.pe = [{xe:1,Rc:1,Sc:1,renderStyleIndex:2}];
		this.name = "Sparks";
		...
		this.ud = function(Bd) {
			...
			Bd._16 = [
				[
					[1,0.987913,0.968473,0.94168,0.907511,0.86592,0.816832,0.760139,0.695691,0.623292,0.542683,0.453525,0.355376,0.24765,0.129556,0,0]
				],
				[
					[1,0.986913,0.966618,0.938898,0.903549,0.860389,0.809266,0.750071,0.682749,0.607317,0.523887,0.432682,0.334064,0.228563,0.116897,0,0]
				]
			];
			Bd._18 = [
				[
	...
	function Emitter_Blast_Core() {
		...
		var _1 = [], _5, _4, _6, _7, _7i0, _7s0 = [];
		this.pe = [{xe:0,Rc:1,Sc:1,renderStyleIndex:3}];
		...
		this.ud = function(Bd) {
			...
			Bd._7 = [
				[
					[0,0.252391,0.413907,0.536299,0.633869,0.713413,0.778892,0.832889,0.877221,0.91323,0.941945,0.964184,0.980605,0.991755,0.99809,1,1],
					[1,0.994276,0.979138,0.955237,0.923054,0.882925,0.835057,0.779525,0.716271,0.645085,0.565564,0.477047,0.378502,0.268299,0.143747,0,0]
				]
			];
			Bd.jd = 100;
			Bd.Vc = 0;
	...
	function Emitter_Smoke() {
		...
		var _1 = [], _3 = [], _5, _7, _9=[], _10, _12, _11, _13, _14, _14i0, _14s0 = [];
		this.pe = [{xe:0,Rc:1,Sc:1,renderStyleIndex:4}];
		this.name = "Smoke";
		...
		this.ud = function(Bd) {
			...
			Bd._14 = [
				[
					[0,0.00132173,0.00435881,0.00908884,0.0154361,0.023256,0.0323214,0.0423132,0.0528225,0.0633654,0.073415,0.0824432,0.0899658,0.0955805,0.0989885,0.1,0.1],
					[0.1,0.098408,0.0943513,0.0880255,0.079805,0.0702197,0.059887,0.0494209,0.0393534,0.0300894,0.0219008,0.0149435,0.00928552,0.00493396,0.00185696,0,0]
				]
			];
			Bd.jd = 100;
			Bd.Vc = 0;
