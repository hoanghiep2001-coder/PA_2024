import KingController from "../Controller/KingController";
...
export default class Army extends cc.Component {
    ...
    private checkDoneAttackAnim(isKing: boolean, o:cc.PhysicsCollider): void {
        this.spine.setCompleteListener((trackEntry: sp.spine.TrackEntry) => {
            if (trackEntry.animation.name === "Attack") {

                // nếu là king thì mới cho đấm king
                if(isKing && o.getComponent(KingController)) {
                    o.getComponent(KingController).decreaseHealth();
