...
export default class Responsive extends cc.Component {
    ...
    private setHorizontalForIpX(): void {
        ...
        Constants.Responsive.calculatedY = -135;
        Constants.Responsive.calculatedScale = 1.4;
    ...
    private setIphoneX(): void {
        ...
        Constants.Responsive.calculatedY = -205;
    ...
    private setMobile(): void {
        ...
        if (cc.view.getFrameSize().height / cc.view.getFrameSize().width > 1.5) {
            ...
            Constants.Responsive.calculatedX = -80;
            Constants.Responsive.calculatedY = -155;
            Constants.Responsive.calculatedScale = 1.05;
            ...
            Constants.Responsive.calculatedX = -80;
            Constants.Responsive.calculatedY = -155;
            Constants.Responsive.calculatedScale = 0.88;
