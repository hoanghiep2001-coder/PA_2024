...
import * as NeutrinoEffect from '../exported_effects/Heart.js';
...
export default class NeutrinoEffectHeart extends NeutrinoComponent {
	getEffectClass() { return NeutrinoEffect; }
	getTexturesDatabase() { return textures; }
}

cc.Assembler.register(NeutrinoEffectHeart, NeutrinoAssembler);
