...
function Rain(ctx) {
	...
	function Emitter_Splash() {
		...
		var _1 = [], _4, _7, _6, _8, _9, _9i0, _9s0 = [], _10;
		...
		this.ud = function(Bd) {
			...
			Bd._9 = [
				[
					[0,1,1],
					[1,0.992551,0.975525,0.950994,0.920057,0.883294,0.84095,0.793007,0.739204,0.678995,0.611449,0.535032,0.447117,0.342717,0.210135,0,0]
				]
			];
			Bd.jd = 1;
			Bd.Vc = 0;
	...
	function Emitter_Drop() {
		...
		var _1, _2 = [], _2i, _2s = [], _3 = [], _3i, _3s = [], _4, _5 = [], _6 = [], _8, _9 = [], _9i, _9s = [], _10 = [], _12, _14=[], _15=[], _15x=[], _15y=[], _15z=[], _16 = [], _17;
		this.pe = [{xe:1,Rc:4,Sc:1,renderStyleIndex:0}];
		this.name = "Drop";

		this.ud = function(Bd) {
			Bd.dd();
			Bd._2 = [
				[[1.60001,0.639999],[800.36,2.52],[800.36,2.52]]
			];
			Bd._3 = [
				[[2.71999,-51.2],[801.92,-49.6],[801.92,-49.6]]
			];
			Bd._9 = [
				[[143.912,1001.9],[-149.088,998.904],[-149.088,998.904]]
			];
			Bd.uc(new Emitter_Splash(), { xc: 1, sd: true });
			Bd.jd = 1000;
			Bd.Vc = 0;
		}
