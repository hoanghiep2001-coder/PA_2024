System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfreq(extras) {
    _reporterNs.report("req", "./GamePlay.js", _context.meta, extras);
  }

  function _reportPossibleCrUseOfd(extras) {
    _reporterNs.report("d", "./GamePlay.js", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      if (!(_crd && req === void 0 ? (_reportPossibleCrUseOfreq({
        ...
        loader.throwInvalidWrapper('./GamePlay.js', _context.meta.url);
      }
...
//# sourceMappingURL=GamePlay.proxy.js@63cjs&original=.js.map