...
export default class Utility extends Singleton<Utility> {
    ...
    static PositionToVector2(_node: cc.Vec3) {
        return new cc.Vec2(_node.x, _node.y);
    ...
    static PlaySound(audioClip: cc.AudioClip, isLoop: boolean) {
        if (Constants.ironSource.SoundState)
            cc.audioEngine.playEffect(audioClip, isLoop);
    }

    static dotProduct = (a: cc.Vec2, b: cc.Vec2): number => {
